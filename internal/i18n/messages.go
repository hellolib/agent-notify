...
var catalog = map[string]map[Lang]string{
	...
	"setup.opencode_tip":         {ZhCN: "提示: 重启 OpenCode 后插件自动加载；确认 ~/.agent-notify/opencode-plugin.js 存在\n", EnUS: "Tip: Restart OpenCode to auto-load the plugin; ensure ~/.agent-notify/opencode-plugin.js exists\n"},
